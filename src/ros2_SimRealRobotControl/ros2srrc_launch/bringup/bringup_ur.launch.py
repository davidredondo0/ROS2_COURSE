...
def generate_launch_description():
    ...
    ros2_control_node = Node(
        ...
        parameters=[robot_description, ros2_controllers_path,{"use_sim_time": True}],
        output="both"
    )
    ...
    trajectory_execution = {
        ...
        "trajectory_execution.allowed_execution_duration_scaling": 15.0, # Value increased to accommodate the "decreased" joint limits.
    ...
    MoveInterface = Node(
        ...
        executable="move",
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": CONFIGURATION["rob"]}, {"EE_PARAM": "none"}, {"ENV_PARAM": "bringup"}, {"use_sim_time": True}],
    )
    # RobMove and RobPose:
    RobMoveInterface = Node(
        ...
        executable="robmove",
        output="screen",
        parameters=[robot_description, robot_description_semantic, kinematics_yaml, {"ROB_PARAM": CONFIGURATION["rob"]}, {"use_sim_time": True}],
    )
