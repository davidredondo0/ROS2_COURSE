...
def generate_launch_description():
    ...
    ompl_planning_yaml = load_yaml("ros2srrc_moveit", "config/ompl_planning.yaml")
    ...
    # Conveyor Manager Node:
    conveyor_manager_node = Node(
        package='ros2srrc_execution',
        executable='conveyor_manager.py',
        output='screen',
    )

    # Parallel Gripper Node:
    parallel_gripper_node = Node(
        package='ros2srrc_execution',
        executable='parallelGripper.py',
        output='screen',
        parameters=[{"EE_PARAM": CONFIGURATION["ee"]}],
    )
            ...
            on_exit = [
                ...
                TimerAction(
                    ...
                    actions=[
                        ...
                        RobMoveInterface,
                        RobPoseInterface,
                        conveyor_manager_node,
                        # grasping_manager_node,
                        parallel_gripper_node,
                    ]
                ),
