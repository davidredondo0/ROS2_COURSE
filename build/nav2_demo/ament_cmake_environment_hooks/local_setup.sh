...
: ${AMENT_CURRENT_PREFIX:="/ros2_ws/install/nav2_demo"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_demo/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_demo/environment/path.sh"
