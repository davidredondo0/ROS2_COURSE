...
class Metaclass_LinkPose(type):
    """Metaclass of message 'LinkPose'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('linkpose_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'linkpose_msgs.msg.LinkPose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__link_pose
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__link_pose
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__link_pose
            cls._TYPE_SUPPORT = module.type_support_msg__msg__link_pose
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__link_pose
...
class LinkPose(metaclass=Metaclass_LinkPose):
    """Message class 'LinkPose'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.modelname = kwargs.get('modelname', str())
        self.linkname = kwargs.get('linkname', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.modelname != other.modelname:
            return False
        if self.linkname != other.linkname:
            return False
        if self.x != other.x:
            return False
        if self.y != other.y:
    ...
    def modelname(self, value):
        if __debug__:
            assert \
                ...
                "The 'modelname' field must be of type 'str'"
        self._modelname = value

    @builtins.property
    def linkname(self):
        """Message field 'linkname'."""
    ...
    def linkname(self, value):
        if __debug__:
            assert \
                isinstance(value, str), \
                "The 'linkname' field must be of type 'str'"
