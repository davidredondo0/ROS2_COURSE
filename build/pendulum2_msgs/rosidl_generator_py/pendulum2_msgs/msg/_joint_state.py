...
class JointState(metaclass=Metaclass_JointState):
    ...
    def __init__(self, **kwargs):
        ...
        self.cart_force = kwargs.get('cart_force', float())
    ...
    def __eq__(self, other):
        ...
        if self.cart_velocity != other.cart_velocity:
            return False
        if self.cart_force != other.cart_force:
            return False
        return True
    ...
    @builtins.property
    def cart_force(self):
        """Message field 'cart_force'."""
        return self._cart_force

    @cart_force.setter
    def cart_force(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'cart_force' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'cart_force' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._cart_force = value
