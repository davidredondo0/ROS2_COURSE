...
#include "pendulum2_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_c.h"
...
using _JointCommand__ros_msg_type = pendulum2_msgs__msg__JointCommand;
...
static uint32_t _JointCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pendulum2_msgs__msg__JointCommand(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum2_msgs__msg__JointCommand;
    is_plain =
      (
...
static size_t _JointCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pendulum2_msgs__msg__JointCommand(
