...
#include "pendulum2_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_c.h"
...
using _JointState__ros_msg_type = pendulum2_msgs__msg__JointState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: cart_force
  {
    cdr << ros_message->cart_force;
  }
...
size_t get_serialized_size_pendulum2_msgs__msg__JointState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name cart_force
  {
    size_t item_size = sizeof(ros_message->cart_force);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _JointState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pendulum2_msgs__msg__JointState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pendulum2_msgs
size_t max_serialized_size_pendulum2_msgs__msg__JointState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum2_msgs__msg__JointState;
    is_plain =
      (
      offsetof(DataType, cart_force) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _JointState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pendulum2_msgs__msg__JointState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pendulum2_msgs, msg, JointState)() {
