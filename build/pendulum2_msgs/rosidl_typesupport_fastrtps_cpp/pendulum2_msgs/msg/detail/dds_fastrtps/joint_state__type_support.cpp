...
#include "pendulum2_msgs/msg/detail/joint_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pendulum2_msgs::msg::JointState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pendulum2_msgs::msg::JointState & ros_message)
{
  // Member: pole_angle
  cdr >> ros_message.pole_angle;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum2_msgs::msg::JointState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pendulum2_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pendulum2_msgs::msg::JointState *>(
    untyped_ros_message);
...
{
  return &pendulum2_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pendulum2_msgs, msg, JointState)() {
  return &pendulum2_msgs::msg::typesupport_fastrtps_cpp::_JointState__handle;
}
