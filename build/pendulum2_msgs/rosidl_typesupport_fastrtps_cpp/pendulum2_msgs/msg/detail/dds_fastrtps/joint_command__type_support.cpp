...
#include "pendulum2_msgs/msg/detail/joint_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pendulum2_msgs::msg::JointCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pendulum2_msgs::msg::JointCommand & ros_message)
{
  // Member: force
  cdr >> ros_message.force;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pendulum2_msgs::msg::JointCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pendulum2_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pendulum2_msgs::msg::JointCommand *>(
    untyped_ros_message);
...
{
  return &pendulum2_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pendulum2_msgs, msg, JointCommand)() {
  return &pendulum2_msgs::msg::typesupport_fastrtps_cpp::_JointCommand__handle;
}
